...
#        - although the accuracy without fine_tuning seems to be quite good,
#          doing some real tests with the tflite model gives awful bad results.
#          Therefore, just always use fine_tuning and be happy after a few epochs.
